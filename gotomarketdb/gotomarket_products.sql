...
CREATE TABLE `products` (
  ...
  `product_description` varchar(120) DEFAULT NULL,
...
INSERT INTO `products` VALUES (3,'prodname','https://img.com','prod test',10,50,2),(4,'prodname','https://img.com','prod test',10,50,2),(5,'prodname','https://img.com','prod test',10,50,2);
